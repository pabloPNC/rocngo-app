...
main_server <- function(input, output, session) {
  ...
  source("./modules/dataPage/dataPageServer.R", local = TRUE)
  source("./modules/plotsPage/plotsPageServer.R", local = TRUE)
  source("./modules/plotsPage/compareServer.R", local = TRUE)
}
